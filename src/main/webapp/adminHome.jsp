	 ...
	 <!-- header -->
        ...
        <div class="navbar">
           ...
           <ul>
                ...
                <li><a href="adminHome.jsp" class="current"><i class="fa fa-home"></i> Home</a></li>
                ...
                <li class="dropdown">
                   <a href="#" class="dropbtn"><i class = "fas fa-bars"></i> MENU &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a>
                   		<div class="dropdown-content">
                   			...
                   			<a href = "${pageContext.request.contextPath}/unitControl?action=LIST1">UnitList</a>

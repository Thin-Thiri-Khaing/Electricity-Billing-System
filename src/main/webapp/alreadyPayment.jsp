...
<body>
		...
		<form action="/ElectricityBill_Project/PaymentForm.jsp" method="post" >
        ...
        <div id="form">
           ...
           <table id="register">
           		...
           		<tr>
           			<td id="error"><h2>Warning!</h2>
           			<br> <br>
           				Bill payment for this month has been processed. <br> <br><br>
                 ...
                 <tr>
                    <td  align="center" id="button"><a href="userHome.jsp"><input type="button" value="Back"  id="btn"></a></td>
				 </tr>  
            </table>
        </div>

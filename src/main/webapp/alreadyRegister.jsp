...
<body>
		...
		<form action="/ElectricityBill_Project/RegisterForm.jsp" method="post" >
        ...
        <div id="form">
           ...
           <table id="register">
           		...
           		<tr>
           			...
           			<br>
           				This Meter Box Id is already registered.
           			</td>
           		</tr>
            ...
            <div id="backBtn"> <a href="RegisterForm.jsp"><td  align="center" id="button"><input type="submit" value="Back"  id="btn"></td></a></div>
        </div>

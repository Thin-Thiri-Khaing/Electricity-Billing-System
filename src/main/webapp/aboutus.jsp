...
<div class="banner">
        ...
        <div class="navbar">
           ...
           <ul>
                ...
                <li><a href="aboutus.jsp" class="current"><i class="fa-regular fa-address-card"></i>&nbsp;&nbsp; About Us</a></li>
                
                        <li class="dropdown">
                            <a href="#" class="dropbtn"><i class="fa-regular fa-user"></i> Log in&nbsp;<i class="fa fa-caret-down"></i> 
                                &nbsp;&nbsp;&nbsp;&nbsp; </a>
    ...
    <table class="tb">
        <tr>
            ...
            <td class="box">
                ...
                The primary objective of the Electricity Billing System is to keep track of payment history, customers information, units, 
                and consumption. It keeps track of all bills and payments.
                <br><br>


                This electricity bill management system project in java, the main goal of the project is to help 
                the electricity department by computerizing the billing system. It primarily focuses on calculating the 
        ...
        <tr>
            <td class="box">
                <p>
                    ...
                    The admin can delete an old customer account with unavailable meter information, assigned to 
        ...
        <tr>
            <td class="box">
                ...
                Registration, Login, Admin and Billing screen.
            </p>
            </td>
        ...
        <div class="contact_container">
            <div class="item">
                ...
                <div class="submit_form">
                    ...
                    <form action="/ElectricityBill_Project/userFeedback_Main">
                        <div class="input_box">

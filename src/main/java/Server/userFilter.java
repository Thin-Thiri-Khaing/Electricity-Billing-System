...
public class userFilter extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			pw.println("<a href='userServlet'><button id='backBtn' class='backBtn'><i class='fa-solid fa-arrow-left-long' id='arrow'></i></button></a>");
			...
			while(rs.next()) {
				pw.println("<tr>");
				pw.println("<td  id='data'>" + rs.getString("id") + " </td>");
				pw.println("<td  id='data'>" + rs.getString("name") + " </td>");
				pw.println("<td  id='data'> " + rs.getString("email") + " </td>"); 
				pw.println("<td  id='data'> " + rs.getString("address") + " </td>");
				pw.println("<td  id='data'> " + rs.getString("phone_no") + " </td>");

...
public class feedbackFilter extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement st = con.prepareStatement("select* from user_feedback where name=?");
			st.setString(1, name);
			...
			pw.println(" <div class='navbar'><ul><li><a href='adminHome.jsp'><i class='fa fa-home'></i> Home</a></li><li><a href='unitRate_Admin'><i class='fa-solid fa-calculator'></i>&nbsp;&nbsp;Unit Rate</a></li><li> <a href='MainHome.jsp'><i class='fa-regular fa-user'></i> Log Out &nbsp;&nbsp;&nbsp;&nbsp; </a></li><li class='dropdown'><a href='#' class='dropbtn current' ><i class = 'fas fa-bars'></i> MENU &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </a><div class='dropdown-content'><a href='userServlet'>UserList</a><a href='paymentList' class='current'>PaymentList</a><a href='unitControl?action=LIST1'>UnitList</a><a href='#' class='current'>User Feedbacks</a></div></li></ul> </div></div> ");
		    
		    pw.println("<h1 align='center' style=''>Search Word - " + name + "</h1>");
			pw.println("<a href='feedbackList'><button id='backBtn' class='backBtn'><i class='fa-solid fa-arrow-left-long' id='arrow'></i></button></a>");
